...
os.system(f"python launch.py --cors-allow-origins=* --skip-torch-cuda-test --disable-nan-check  --no-half --precision full --use-cpu all --enable-insecure-extension-access --theme dark --gradio-queue --disable-safe-unpickle --ui-settings-file /home/xlab-app-center/config.json --ui-config-file /home/xlab-app-center/ui-config.json")
